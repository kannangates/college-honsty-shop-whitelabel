...
import { getCurrentTheme } from '@/config/dynamic';
...
export const AuthPage = () => {
  ...
  return (
    <div 
      ...
      style={{
        background: `linear-gradient(to bottom right, ${theme.colors.primary}, ${theme.colors.accent}, ${theme.colors.secondary})`
      }}
    >
      <div className="absolute inset-0 opacity-30">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${encodeURIComponent(theme.colors.secondary)}' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='4'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
